...
void ofxSVG::createRootSvg() {
    ...
    saveXml.addAttribute("svg", "x", "0px", 0);
    saveXml.addAttribute("svg", "y", "0px", 0);
    saveXml.addAttribute("svg", "width","1200mm", 0);
    saveXml.addAttribute("svg", "height","800mm", 0);
    saveXml.addAttribute("svg", "viewBox", "0 0 1200 800", 0);
...
void ofxSVG::rect(float x, float y, float w, float h) {
	...
	saveXml.addTag("rect");
	saveXml.addAttribute("rect", "height", h, rect_i);
	saveXml.addAttribute("rect", "width", w, rect_i);
	saveXml.addAttribute("rect", "x", x, rect_i);
	saveXml.addAttribute("rect", "y", y, rect_i);
	saveXml.addAttribute("rect", "fill", currentAttributes["color"], rect_i);
	saveXml.addAttribute("rect", "stroke", currentAttributes["stroke"], rect_i);
	saveXml.addAttribute("rect", "stroke-width", currentAttributes["strokewidth"], rect_i);
    saveXml.popTag();
...
void ofxSVG::line(float x, float y, float w, float h) {
	...
	saveXml.addTag("line");
	saveXml.addAttribute("line", "x1", x, line_i);
	saveXml.addAttribute("line", "y1", y, line_i);
	saveXml.addAttribute("line", "x2", w, line_i);
	saveXml.addAttribute("line", "y2", h, line_i);
	saveXml.addAttribute("line", "fill", currentAttributes["color"], line_i);
	saveXml.addAttribute("line", "stroke", currentAttributes["stroke"], line_i);
	saveXml.addAttribute("line", "stroke-width", currentAttributes["strokewidth"], line_i);
    saveXml.popTag();
...
void ofxSVG::ellipse(float x, float y, float rx, float ry) {
	...
	saveXml.setAttribute("ellipse", "ry", ry/2.0, ellipse_i);
	saveXml.setAttribute("ellipse", "rx", rx/2.0, ellipse_i);
	saveXml.setAttribute("ellipse", "cx", x, ellipse_i);
	saveXml.setAttribute("ellipse", "cy", y, ellipse_i);
	saveXml.setAttribute("ellipse", "fill", currentAttributes["color"], ellipse_i);
	saveXml.setAttribute("ellipse", "stroke", currentAttributes["stroke"], ellipse_i);
	saveXml.setAttribute("ellipse", "stroke-width", currentAttributes["strokewidth"], ellipse_i);
	saveXml.popTag();
...
void ofxSVG::circle(float x, float y, float r) {
	...
	saveXml.setAttribute("circle", "r", r/2.0, circle_i);
	saveXml.setAttribute("circle", "cx", x, circle_i);
	saveXml.setAttribute("circle", "cy", y, circle_i);
	saveXml.setAttribute("circle", "fill", currentAttributes["color"], circle_i);
	saveXml.setAttribute("circle", "stroke", currentAttributes["stroke"], circle_i);
	saveXml.setAttribute("circle", "stroke-width", currentAttributes["strokewidth"], circle_i);
	saveXml.popTag();
    
    circle_i++;
}

void ofxSVG::text(string text, float x, float y){
	...
	saveXml.addTag("text");
	saveXml.setAttribute("text", "x", x, text_i);
	saveXml.setAttribute("text", "y", y, text_i);
	saveXml.setAttribute("text", "fill", "#000", text_i);
    saveXml.setAttribute("text", "font-family", "MS-Gothic", text_i);
	saveXml.setValue("text", text, text_i);
	saveXml.popTag();
    
    text_i++;
}

void ofxSVG::groupBegin() {
	saveXml.pushTag("svg", 0);
	//saveXml.pushTag("rect", 0);// <rect
    group = true;
	saveXml.addTag("g");
...
void ofxSVG::stroke(string colorHex, float weight) {
